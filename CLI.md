...
- `--force-pot`: Force power-of-two texture dimensions (better GPU
  compatibility)
- `--analyze-animations / --skip-animation-analysis`: Analyze bones for
  static/animated properties \[default: analyze-animations\]
- `--check-bloat / --skip-bloat-check`: Analyze meshes for unreasonable
  complexity \[default: check-bloat\]
